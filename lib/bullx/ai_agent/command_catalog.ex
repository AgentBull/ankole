defmodule BullX.AIAgent.CommandCatalog do
  @moduledoc """
  ...
  @system_commands [
    %{
      name: "command",
      slash: "/command",
      alias_key: "ai_agent.commands.aliases.command",
      target_ref: "bullx.system.command_list",
      description_key: "ai_agent.commands.descriptions.command"
    },
    %{
      name: "status",
      slash: "/status",
      alias_key: "ai_agent.commands.aliases.status",
      target_ref: "bullx.system.status",
      description_key: "ai_agent.commands.descriptions.status"
    }
  ]
  ...
  @ai_agent_commands [
    %{
      name: "new",
      slash: "/new",
      alias_key: "ai_agent.commands.aliases.new",
      description_key: "ai_agent.commands.descriptions.new"
    },
    %{
      name: "compress",
      slash: "/compress",
      alias_key: "ai_agent.commands.aliases.compress",
      description_key: "ai_agent.commands.descriptions.compress"
    },
    %{
      name: "retry",
      slash: "/retry",
      alias_key: "ai_agent.commands.aliases.retry",
      description_key: "ai_agent.commands.descriptions.retry"
    },
    %{
      name: "steer",
      slash: "/steer",
      alias_key: "ai_agent.commands.aliases.steer",
      description_key: "ai_agent.commands.descriptions.steer"
    },
    %{
      name: "stop",
      slash: "/stop",
      alias_key: "ai_agent.commands.aliases.stop",
      description_key: "ai_agent.commands.descriptions.stop"
    },
    %{
      name: "undo",
      slash: "/undo",
      alias_key: "ai_agent.commands.aliases.undo",
      description_key: "ai_agent.commands.descriptions.undo"
    }
  ]
