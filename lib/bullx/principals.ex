defmodule BullX.Principals do
  ...
  defdelegate fetch_login_provider(provider_id), to: BullX.Principals.LoginProviders, as: :fetch
  defdelegate login_provider_ids(), to: BullX.Principals.LoginProviders, as: :provider_ids
end
