defmodule Ankole.Plugins.TelegramAdapter.ConnectionSupervisor do
  @moduledoc false

  alias Ankole.Plugins.TelegramAdapter.ConnectionOwner
  alias Ankole.SignalsGateway.AdapterContext

  @registry Ankole.Plugins.TelegramAdapter.ConnectionRegistry
  @supervisor Ankole.Plugins.TelegramAdapter.ConnectionDynamicSupervisor
  ...
  def ensure_started(_config, _consumers), do: {:error, :invalid_telegram_consumer}
