defmodule Discord.ChannelAdapter do
  ...
  defp maybe_reply_activation_required(attrs, %Source{} = source) do
    case get_in(attrs, [:data, :routing_facts, "guild_id"]) do
      nil -> maybe_reply(attrs, source, BullX.I18n.t("eventbus.discord.auth.activation_required"))
      _guild -> maybe_reply(attrs, source, BullX.I18n.t("eventbus.discord.auth.direct_command_dm_only"))
    end
  end
