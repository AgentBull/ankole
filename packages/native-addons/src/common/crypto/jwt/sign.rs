...
use crate::common::crypto::jwt::{claims::Claims, header::JWTHeader};
...
impl SignTask {
  #[inline]
  pub fn sign(claims: &Claims, header: &JWTHeader, key: &[u8]) -> Result<String> {
...
pub fn jwt_sign(
  ...
  Ok(AsyncTask::with_optional_signal(
    SignTask {
      header: match header {
        Some(h) => h.merge(JWTHeader::default()),
        _ => JWTHeader::default(),
      },
      claims,
