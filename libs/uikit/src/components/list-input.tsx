...
/** Edits a string array with chips plus comma/newline paste support. */
export function StringListInput({
  ...
  function addMany(raw: string) {
    // Provider consoles often copy lists as comma-separated or newline-separated
    // text. Handling both forms keeps the component useful in setup forms.
...
/** Edits a string array by selecting multiple known options. */
...
function parseJson(value: string) {
  ...
  try {
    ...
    // Free-form text remains valid input. This lets callers use the same control
    // for mixed scalar lists without losing what the user typed.
    return value
  }
}
