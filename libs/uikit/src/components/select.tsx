...
function SelectTrigger({
  ...
  React.useLayoutEffect(() => {
    const theme = triggerRef.current?.closest<HTMLElement>('[data-theme]')?.getAttribute('data-theme') || undefined
