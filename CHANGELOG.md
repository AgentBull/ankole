...
- README and website now present Ankole as the open source Claude Code alternative for company work and an enterprise Agent Harness with a Company Brain. English, Simplified Chinese, Japanese, and Korean explain how shared knowledge, authority, persistent execution, and feedback improve company decisions.
