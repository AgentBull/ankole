...
export type ConsumerScope = 'app' | 'package' | 'plugin' | 'tool' | 'webui' | 'test' | 'other'
...
export type SymbolKind = 'function' | 'class' | 'interface' | 'type' | 'enum' | 'variable' | 'unknown'
