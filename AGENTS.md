...
Normally use 1–4 concise bullets for each version. Describe outcomes and any required operator action. Do not include file or test inventories or implementation narratives. The bullets must still cover every material retained change in the commit.
