...
export class StreamingPlan implements PostableObject<StreamingPlanData> {
  ...
  private readonly _stream: AsyncIterable<string | StreamChunk>
  private readonly _options: StreamingPlanOptions

  constructor(stream: AsyncIterable<string | StreamChunk>, options: StreamingPlanOptions = {}) {
    this._stream = stream
    this._options = options
  }

  get stream(): AsyncIterable<string | StreamChunk> {
    return this._stream
  }
