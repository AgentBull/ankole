// @ts-nocheck
import type { ImageModelV4Usage, JSONObject, LanguageModelV4Usage } from '@/llm/provider'
 ...
 */
// TODO replace with EmbeddingModelV4Usage once available in @/llm/provider
...
export function asLanguageModelUsage(usage: LanguageModelV4Usage): LanguageModelUsage {
  return {
