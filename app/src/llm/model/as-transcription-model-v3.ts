// @ts-nocheck
import type { TranscriptionModelV2, TranscriptionModelV3 } from '@/llm/provider'
import { logV2CompatibilityWarning } from '../util/log-v2-compatibility-warning'

export function asTranscriptionModelV3(model: TranscriptionModelV3 | TranscriptionModelV2): TranscriptionModelV3 {
