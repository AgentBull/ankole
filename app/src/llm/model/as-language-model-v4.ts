// @ts-nocheck
import type { LanguageModelV2, LanguageModelV3, LanguageModelV4 } from '@/llm/provider'
import { asLanguageModelV3 } from './as-language-model-v3'

export function asLanguageModelV4(model: LanguageModelV2 | LanguageModelV3 | LanguageModelV4): LanguageModelV4 {
