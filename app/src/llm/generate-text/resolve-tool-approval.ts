// @ts-nocheck
import type { Context, InferToolInput, InferToolSetContext, ModelMessage, ToolSet } from '@/llm/provider-utils'
 ...
 */
export async function resolveToolApproval<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context | unknown | never>({
  tools,
  toolCall,
  toolApproval,
  messages,
