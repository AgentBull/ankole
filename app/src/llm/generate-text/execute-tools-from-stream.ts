...
export function executeToolsFromStream<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context | unknown | never>({
  stream,
  tools,
  callId,
  messages,
  ...
  return stream.pipeThrough(
    new TransformStream<LanguageModelStreamPart<TOOLS>, ExecuteToolsStreamPart<TOOLS>>({
      async transform(
