...
import type { InferToolInput, InferToolOutput, Tool, ToolCall, ToolSet } from '@/llm/provider-utils'
...
export type FileUIPart = {
   ...
   * `@/llm/provider-utils` (`isFullMediaType`, `getTopLevelMediaType`,
 ...
 */
export function isCustomContentUIPart(part: UIMessagePart<UIDataTypes, UITools>): part is CustomContentUIPart {
 ...
 */
export function isReasoningFileUIPart(part: UIMessagePart<UIDataTypes, UITools>): part is ReasoningFileUIPart {
 ...
 */
export function isReasoningUIPart(part: UIMessagePart<UIDataTypes, UITools>): part is ReasoningUIPart {
 ...
 */
export function isDynamicToolUIPart(part: UIMessagePart<UIDataTypes, UITools>): part is DynamicToolUIPart {
