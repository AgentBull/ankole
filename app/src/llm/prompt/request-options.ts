// @ts-nocheck
import type { ToolSet } from '@/llm/provider-utils'
 ...
 */
export function getTotalTimeoutMs(timeout: TimeoutConfiguration<any> | undefined): number | undefined {
  if (timeout == null) {
    return undefined
  }
 ...
 */
export function getStepTimeoutMs(timeout: TimeoutConfiguration<any> | undefined): number | undefined {
 ...
 */
export function getChunkTimeoutMs(timeout: TimeoutConfiguration<any> | undefined): number | undefined {
  if (timeout == null || typeof timeout === 'number') {
    return undefined
  }
