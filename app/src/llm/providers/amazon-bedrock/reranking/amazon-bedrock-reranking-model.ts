// @ts-nocheck
import type { RerankingModelV4 } from '@/llm/provider'
import {
  combineHeaders,
...
import { amazonBedrockRerankingResponseSchema, type AmazonBedrockRerankingInput } from './amazon-bedrock-reranking-api'
import {
...
export class AmazonBedrockRerankingModel implements RerankingModelV4 {
  ...
  async doRerank({
    ...
    const {
      ...
      successfulResponseHandler: createJsonResponseHandler(amazonBedrockRerankingResponseSchema),
