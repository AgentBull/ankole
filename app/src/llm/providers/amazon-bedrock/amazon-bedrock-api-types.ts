...
export interface AmazonBedrockConverseInput {
  ...
  guardrailConfig?: AmazonBedrockGuardrailConfiguration | AmazonBedrockGuardrailStreamConfiguration | undefined
}

export type AmazonBedrockSystemMessages = Array<AmazonBedrockSystemContentBlock>

export type AmazonBedrockMessages = Array<AmazonBedrockAssistantMessage | AmazonBedrockUserMessage>
 ...
 */
export function createAmazonBedrockCachePoint(ttl?: AmazonBedrockCacheTTL): AmazonBedrockCachePoint {
  return {
    cachePoint: { type: 'default', ttl }
  }
}

export type AmazonBedrockSystemContentBlock = { text: string } | AmazonBedrockCachePoint
...
export type AmazonBedrockGuardrailStreamConfiguration = AmazonBedrockGuardrailConfiguration
...
export type AmazonBedrockImageFormat = AmazonBedrockImageFormats[keyof AmazonBedrockImageFormats]
...
export type AmazonBedrockDocumentFormat = AmazonBedrockDocumentFormats[keyof AmazonBedrockDocumentFormats]
...
export interface AmazonBedrockToolResultBlock {
  toolResult: {
    toolUseId: string
    content: Array<AmazonBedrockTextBlock | AmazonBedrockImageBlock | AmazonBedrockDocumentBlock>
  }
}
