...
export type AmazonBedrockFilePartProviderOptions = z.infer<typeof amazonBedrockFilePartProviderOptions>
...
export const amazonBedrockLanguageModelChatOptions = z.object({
  ...
  reasoningConfig: z
    .object({
      type: z.union([z.literal('enabled'), z.literal('disabled'), z.literal('adaptive')]).optional(),
...
export type AmazonBedrockLanguageModelChatOptions = z.infer<typeof amazonBedrockLanguageModelChatOptions>
