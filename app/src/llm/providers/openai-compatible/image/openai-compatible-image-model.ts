// @ts-nocheck
import type { ImageModelV4, ImageModelV4File, SharedV4ProviderOptions, SharedV4Warning } from '@/llm/provider'
import { toCamelCase, warnIfDeprecatedProviderOptionsKey } from '../utils/to-camel-case'
import {
  combineHeaders,
...
export class OpenAICompatibleImageModel implements ImageModelV4 {
  ...
  static [WORKFLOW_DESERIALIZE](options: { modelId: string; config: OpenAICompatibleImageModelConfig }) {
  ...
  private getArgs(providerOptions: SharedV4ProviderOptions, warnings: SharedV4Warning[]): Record<string, unknown> {
