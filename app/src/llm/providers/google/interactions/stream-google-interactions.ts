...
import { googleInteractionsEventSchema, type GoogleInteractionsEvent } from './google-interactions-api'
...
export function streamGoogleInteractionEvents({
  ...
  let currentReader: ReadableStreamDefaultReader<ParseResult<GoogleInteractionsEvent>> | undefined
