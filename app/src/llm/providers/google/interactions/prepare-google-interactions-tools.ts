// @ts-nocheck
import type { LanguageModelV4CallOptions, SharedV4Warning } from '@/llm/provider'
import type { GoogleInteractionsTool, GoogleInteractionsToolChoice } from './google-interactions-prompt'
    ...
    if (tool.type === 'provider') {
      ...
      switch (tool.id) {
        case 'google.google_search': {
          const searchTypesArg = args.searchTypes as { webSearch?: unknown; imageSearch?: unknown } | undefined
          let search_types: Array<'web_search' | 'image_search' | 'enterprise_web_search'> | undefined
          if (searchTypesArg != null && typeof searchTypesArg === 'object') {
            const list: Array<'web_search' | 'image_search' | 'enterprise_web_search'> = []
        ...
        case 'google.file_search': {
          interactionsTools.push({
            ...
            ...(args.fileSearchStoreNames != null
              ? {
                  file_search_store_names: args.fileSearchStoreNames as Array<string>
                }
              : {}),
            ...(args.topK != null ? { top_k: args.topK as number } : {}),
            ...(args.metadataFilter != null ? { metadata_filter: args.metadataFilter as string } : {})
          })
          break
        }
        case 'google.google_maps': {
          interactionsTools.push({
            type: 'google_maps',
            ...(args.latitude != null ? { latitude: args.latitude as number } : {}),
            ...(args.longitude != null ? { longitude: args.longitude as number } : {}),
            ...(args.enableWidget != null ? { enable_widget: args.enableWidget as boolean } : {})
          })
          break
        }
        case 'google.computer_use': {
          interactionsTools.push({
            type: 'computer_use',
            environment: (args.environment as 'browser' | undefined) ?? 'browser',
            ...(args.excludedPredefinedFunctions != null
              ? {
                  excludedPredefinedFunctions: args.excludedPredefinedFunctions as Array<string>
                }
              : {})
          })
          break
        ...
        case 'google.mcp_server': {
          interactionsTools.push({
            ...
            ...(args.headers != null ? { headers: args.headers as Record<string, string> } : {}),
            ...(args.allowedTools != null ? { allowed_tools: args.allowedTools as Array<unknown> } : {})
          })
          break
        }
        case 'google.retrieval': {
          const vertexAiSearchConfig =
            (args.vertexAiSearchConfig as { datastores?: Array<string>; engine?: string } | undefined) ?? undefined
          interactionsTools.push({
            type: 'retrieval',
            ...(args.retrievalTypes != null
              ? {
                  retrieval_types: args.retrievalTypes as Array<'vertex_ai_search'>
                }
