// @ts-nocheck
import type { JSONSchema7 } from '@/llm/provider'
...
export type AnthropicContextManagementTrigger = AnthropicInputTokensTrigger | AnthropicToolUsesTrigger
      ...
      content: z.array(
        z.discriminatedUnion('type', [
          ...
          z.object({
            ...
            is_error: z.boolean(),
            content: z.array(z.union([z.string(), z.object({ type: z.literal('text'), text: z.string() })]))
          }),
          z.object({
