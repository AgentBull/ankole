// @ts-nocheck
import type { SharedV4Warning, SharedV4ProviderMetadata } from '@/llm/provider'
...
function getCacheControl(providerMetadata: SharedV4ProviderMetadata | undefined): AnthropicCacheControl | undefined {
