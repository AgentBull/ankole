// @ts-nocheck
import { UnsupportedFunctionalityError, type LanguageModelV4FilePart, type LanguageModelV4Prompt } from '@/llm/provider'
import type { MistralPrompt } from './mistral-chat-prompt'
import { convertToBase64, getTopLevelMediaType, resolveFullMediaType } from '@/llm/provider-utils'
...
export function convertToMistralChatMessages(prompt: LanguageModelV4Prompt): MistralPrompt {
