...
import { openaiEmbeddingModelOptions, type OpenAIEmbeddingModelId } from './openai-embedding-model-options'
...
export class OpenAIEmbeddingModel implements EmbeddingModelV4 {
  ...
  static [WORKFLOW_DESERIALIZE](options: { modelId: OpenAIEmbeddingModelId; config: OpenAIConfig }) {
