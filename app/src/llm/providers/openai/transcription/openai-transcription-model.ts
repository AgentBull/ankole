// @ts-nocheck
import type { TranscriptionModelV4, TranscriptionModelV4CallOptions, SharedV4Warning } from '@/llm/provider'
import {
  combineHeaders,
...
export type OpenAITranscriptionCallOptions = Omit<TranscriptionModelV4CallOptions, 'providerOptions'> & {
  providerOptions?: {
