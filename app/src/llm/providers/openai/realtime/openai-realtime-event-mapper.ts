 ...
 */
export function parseOpenAIRealtimeServerEvent(raw: unknown): RealtimeModelV4ServerEvent {
 ...
 */
export function serializeOpenAIRealtimeClientEvent(event: RealtimeModelV4ClientEvent, modelId: string): unknown {
  switch (event.type) {
    case 'session-update':
      return {
        type: 'session.update',
