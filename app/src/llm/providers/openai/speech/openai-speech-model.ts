...
import { openaiSpeechModelOptionsSchema, type OpenAISpeechModelId } from './openai-speech-model-options'
...
export class OpenAISpeechModel implements SpeechModelV4 {
  ...
  static [WORKFLOW_DESERIALIZE](options: { modelId: OpenAISpeechModelId; config: OpenAISpeechModelConfig }) {
