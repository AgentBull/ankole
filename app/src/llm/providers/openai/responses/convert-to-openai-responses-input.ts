...
import { applyPatchInputSchema, applyPatchOutputSchema } from '../tool/apply-patch'
...
import { toolSearchInputSchema, toolSearchOutputSchema } from '../tool/tool-search'
                    ...
                    if (topLevel === 'image') {
                      return {
                        ...
                        ...(part.data.type === 'url'
                          ...
                          : typeof part.data.data === 'string' && isFileId(part.data.data, fileIdPrefixes)
      ...
      case 'tool': {
        for (const part of content) {
          if (part.type === 'tool-approval-response') {
            const approvalResponse = part as LanguageModelV4ToolApprovalResponsePart
