// @ts-nocheck
import type { SharedV4Warning, TranscriptionModelV4 } from '@/llm/provider'
import {
  combineHeaders,
...
function parseDurationSeconds(value: string | null | undefined): number | undefined {
  if (value == null) {
    return undefined
  }
...
function convertBcp47ToIso6391(value: string | null | undefined): string | undefined {
  if (value == null) {
    return undefined
  }
