// @ts-nocheck
import type { GoogleLanguageModelOptions } from '@/llm/providers/google'
import { GoogleLanguageModel } from '@/llm/providers/google/internal'
import type { ImageModelV4, ImageModelV4File, LanguageModelV4Prompt, SharedV4Warning } from '@/llm/provider'
import {
  combineHeaders,
  convertToBase64,
...
export class GoogleVertexImageModel implements ImageModelV4 {
  ...
  static [WORKFLOW_DESERIALIZE](options: { modelId: string; config: GoogleVertexImageModelConfig }) {
  ...
  private async doGenerateGemini({
    ...
    const userVertexOptions = (providerOptions?.googleVertex ?? providerOptions?.vertex) as
