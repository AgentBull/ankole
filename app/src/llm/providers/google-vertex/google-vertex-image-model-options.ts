...
export const googleVertexImageModelOptionsSchema = z.object({
  ...
  safetySetting: z.enum(['block_low_and_above', 'block_medium_and_above', 'block_only_high', 'block_none']).nullish(),
...
export type GoogleVertexImageModelOptions = z.infer<typeof googleVertexImageModelOptionsSchema>
