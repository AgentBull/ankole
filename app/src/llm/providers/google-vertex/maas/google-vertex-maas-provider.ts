 ...
 */
export function createGoogleVertexMaas(options: GoogleVertexMaasProviderSettings = {}): GoogleVertexMaasProvider {
  ...
  provider.languageModel = (modelId: GoogleVertexMaasModelId) => getProvider().languageModel(modelId)
  provider.chatModel = (modelId: GoogleVertexMaasModelId) => getProvider().chatModel(modelId)
  provider.completionModel = (modelId: string) => getProvider().completionModel(modelId)
  provider.embeddingModel = (modelId: string) => getProvider().embeddingModel(modelId)
  provider.textEmbeddingModel = (modelId: string) => getProvider().textEmbeddingModel(modelId)
