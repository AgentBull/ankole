...
export type { GoogleVertexSpeechModelId, GoogleVertexSpeechModelOptions } from './google-vertex-speech-model-options'
export {
  createGoogleVertex,
...
export type { GoogleVertexProvider, GoogleVertexProviderSettings } from './google-vertex-provider'
