  ...
  zodSchema(
    z.object({
      ...
      max_tokens_per_page: z
        .number()
        .optional()
        .describe('Maximum number of tokens to extract per search result page (256-2048, default: 2048)'),
...
export const perplexitySearch = (config: PerplexitySearchConfig = {}): ReturnType<typeof perplexitySearchToolFactory> =>
