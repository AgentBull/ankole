// @ts-nocheck
import type { ImageModelV4, ImageModelV4File, ImageModelV4ProviderMetadata } from '@/llm/provider'
import {
  combineHeaders,
...
export class GatewayImageModel implements ImageModelV4 {
  ...
  static [WORKFLOW_DESERIALIZE](options: { modelId: string; config: GatewayImageConfig }) {
  ...
  async doGenerate({
    ...
    try {
      ...
      return {
        ...
        providerMetadata: responseBody.providerMetadata as ImageModelV4ProviderMetadata,
        response: {
          timestamp: new Date(),
