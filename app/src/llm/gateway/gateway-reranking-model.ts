// @ts-nocheck
import type { RerankingModelV4, SharedV4ProviderMetadata } from '@/llm/provider'
import {
  combineHeaders,
...
export class GatewayRerankingModel implements RerankingModelV4 {
  ...
  async doRerank({
    ...
    abortSignal,
    providerOptions
  }: Parameters<RerankingModelV4['doRerank']>[0]): Promise<Awaited<ReturnType<RerankingModelV4['doRerank']>>> {
