 ...
 */
export type ProviderDefinedToolFactory<INPUT, ARGS extends object, CONTEXT extends Context = {}> = <OUTPUT>(
  options: ARGS & {
...
export function createProviderDefinedToolFactory<INPUT, ARGS extends object, CONTEXT extends Context = {}>({
  id,
  inputSchema
}: {
  id: `${string}.${string}`
