...
/**
 * Renders the server-owned HTML shell for one SPA entry.
 *
 * In development it delegates to Bun's fullstack route so HMR scripts are
 * present. In production it reads the asset manifest generated by
 * `scripts/build-web-assets.ts` and falls back to stable default names if the
 * manifest is missing.
 */
...
/**
 * Returns Bun-generated development HTML with server-side placeholders applied.
 */
...
/**
 * Reads and caches the production asset manifest outside development.
 */
...
/**
 * Escapes text inserted into generated HTML.
 */
