...
export declare class ActorBusDealer {
...
export type JsActorBusDealer = ActorBusDealer

/** Decodes Actor Bus v1 protobuf bytes into a JSON-shaped envelope. */
export declare function actorBusDecodeEnvelope(bytes: Buffer): any

/** Encodes an Actor Bus v1 envelope into protobuf bytes. */
export declare function actorBusEncodeEnvelope(envelope: any): Buffer
