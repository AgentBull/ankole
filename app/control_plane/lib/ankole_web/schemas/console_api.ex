    ...
    OpenAPISpex.schema(
      %{
        ...
        properties: %{
          ...
          max_running_per_agent: %Schema{type: :integer},
          agents_at_running_cap: %Schema{type: :integer},
          queued_behind_running_cap: %Schema{type: :integer},
        ...
        required: [
          ...
          :agents_at_running_cap,
          :queued_behind_running_cap,
          :claims_24h,
