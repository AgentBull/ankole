...
export const modelAdvanced = {
  title: '선택적 Agent profile과 Brain 모델',
  summary: 'Agent 기능 profile은 필요할 때만 설정합니다. Brain 모델은 인스턴스 전체에 적용됩니다.',
  steps: [
    {
    ...
    {
      title: '인스턴스의 Brain 모델 구성',
      body: [
        'Console → AppConfigure → Brain을 여세요. 이 설정은 모든 Agent에 적용되며 Agent profile에 속하지 않습니다.'
      ],
      fields: [
        {
        ...
        },
        {
          ...
          description: 'URL Source에서 읽을 수 있는 본문을 가져옵니다.'
        },
        {
          name: 'brain.extraction_model',
          description: 'Signal 대화와 Source에서 지식을 추출합니다.'
        },
        {
          name: 'brain.dreaming_model',
          description: '지식을 통합하고 모델이 필요한 유지 관리 작업을 수행합니다.'
        }
      ],
      links: [
