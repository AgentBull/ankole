...
export const channelTabs = [
  ...
  },
  {
    ...
    prerequisites: ['@BotFather와 대화할 수 있는 Telegram 계정', '테스트용 개인 채팅 또는 그룹'],
    basic: {
      title: 'Telegram bot 준비',
      steps: [
        {
          title: '@BotFather로 bot 생성',
          body: [
            '@BotFather에 /newbot을 보내고 표시 이름과 bot으로 끝나는 사용자 이름을 선택한 다음, BotFather가 돌려주는 token을 복사하세요. 라우팅 규칙에 필요한 자격 증명은 이 token 하나입니다.'
          ]
        },
        {
          title: 'bot이 그룹 메시지를 읽도록 허용',
          body: [
          ...
          fields: [
            {
              name: 'botToken',
              value: '123456789:AA…',
              description: '@BotFather가 발급한 bot token입니다. 하나의 token은 활성화된 라우팅 규칙 하나에만 속할 수 있습니다.'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: '여기서 시작하세요. 직접 메시지, @멘션, /command@bot, bot에 대한 답장이 Agent를 지목합니다.'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'identity 매핑, forum topic, 플랫폼 제한',
      summary: 'Telegram 사용자를 계정에 매핑하는 방법과 Agent가 사용할 수 없는 Telegram 기능을 확인하려면 펼치세요.',
      steps: [
        {
          title: 'Telegram 사용자를 계정에 매핑',
          body: [
        ...
        {
          title: 'Agent마다 별도 bot 사용',
          body: ['하나의 bot token은 활성화된 라우팅 규칙 하나에만 바인딩할 수 있습니다. 추가 Agent마다 @BotFather에서 bot을 하나 더 만드세요.']
        }
      ]
    }
  },
  {
    ...
    basic: {
      title: 'Discord bot 준비',
      steps: [
        {
          title: '애플리케이션과 bot 생성',
          body: [
        ...
        {
          title: 'message content intent 활성화',
          body: [
          ...
          caution: 'Server Members Intent와 Presence Intent는 필요하지 않습니다. 100개가 넘는 서버에 있는 애플리케이션은 message content intent를 유지하려면 Discord 인증이 필요합니다.'
        },
        {
          title: 'bot을 서버에 초대',
          body: [
          ...
          copyItems: [
            { value: 'View Channels', description: 'bot이 허용된 채널 보기' },
            { value: 'Send Messages', description: 'Agent 답장 게시' },
            { value: 'Send Messages in Threads', description: 'thread 안에서 답장' },
            { value: 'Read Message History', description: '이전 메시지에 답장하고 편집' },
            { value: 'Attach Files', description: 'Agent가 보낸 파일 업로드' },
            { value: 'Add Reactions', description: '반응 추가 및 제거' }
          ]
        },
        {
          title: 'Interactions Endpoint URL 비워 두기',
          body: [
        ...
        },
        {
          ...
          fields: [
            {
              name: 'botToken',
              description: 'Bot 페이지의 bot token입니다. 하나의 token은 활성화된 라우팅 규칙 하나에만 속할 수 있습니다.'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: '여기서 시작하세요. 직접 메시지, @멘션, bot에 대한 답장이 Agent를 지목합니다.'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'identity 매핑, thread, 플랫폼 제한',
      summary: 'Discord 사용자를 계정에 매핑하는 방법과 Agent가 사용할 수 없는 Discord 기능을 확인하려면 펼치세요.',
      steps: [
        {
          title: 'Discord 사용자를 계정에 매핑',
          body: [
        ...
        {
          title: 'Agent마다 별도 bot 사용',
          body: ['하나의 bot token은 활성화된 라우팅 규칙 하나에만 바인딩할 수 있습니다. 추가 Agent마다 애플리케이션을 하나 더 만드세요.']
        }
      ]
    }
  },
  {
    ...
    alert: {
      title: 'LINE은 일부 Ankole 기능을 제한합니다',
      body: [
    ...
    basic: {
      title: 'LINE Official Account 준비',
      steps: [
        {
          title: 'Messaging API channel 생성 및 자격 증명 수집',
          body: [
        ...
        {
          title: 'webhook을 검증하기 전에 라우팅 규칙 생성',
          body: [
        ...
        },
        {
          ...
          fields: [
            {
              name: 'channelId',
              description: 'Messaging API Channel ID입니다. 하나의 channel은 활성화된 라우팅 규칙 하나에만 속할 수 있습니다.'
            },
            {
              name: 'channelSecret',
              description: 'Basic settings의 Channel secret입니다. Ankole이 webhook 서명을 검증할 때 사용합니다.'
            },
            {
              name: 'channelAccessToken',
              description: 'Messaging API tab에서 발급한 장기 channel access token입니다.'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: '여기서 시작하세요. LINE은 모든 그룹 메시지를 전달하므로 observe_all과 may_intervene도 추가 권한 없이 동작합니다.'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'identity 매핑, 그룹 답장, 플랫폼 제한',
      summary: 'LINE 사용자를 계정에 매핑하는 방법과 그룹에서 Agent가 동작하는 방식을 확인하려면 펼치세요.',
      steps: [
        {
          title: 'LINE 사용자를 계정에 매핑',
          body: [
        ...
        {
          title: 'Agent마다 별도 channel 사용',
          body: ['하나의 Messaging API channel은 활성화된 라우팅 규칙 하나에만 속할 수 있습니다. 추가 Agent마다 channel을 하나 더 만드세요.']
        }
      ]
    }
  },
  {
    ...
    alert: {
      title: 'WhatsApp은 일부 Ankole 기능을 제한합니다',
      body: [
    ...
    basic: {
      title: 'WhatsApp Business 전화번호 준비',
      steps: [
        {
          title: 'WhatsApp 제품 연결 및 식별자 수집',
          body: [
        ...
        },
        {
          ...
          fields: [
            {
              name: 'appId',
              description: 'Meta App ID입니다. 하나의 App에 속한 여러 전화번호가 각자 다른 Agent를 담당할 수 있으며, 그 규칙들은 같은 App secret과 verify token을 공유해야 합니다.'
            },
            {
              name: 'appSecret',
              description: 'App settings → Basic의 App secret입니다. Ankole이 webhook 서명을 검증할 때 사용합니다.'
            },
            {
              name: 'verifyToken',
              description: '직접 정하는 값입니다. Meta callback 구성에 같은 값을 입력하세요.'
            },
            {
              name: 'phoneNumberId',
              description: 'WhatsApp → API Setup의 Phone number ID입니다. 하나의 번호는 활성화된 라우팅 규칙 하나에만 속할 수 있습니다.'
            },
            {
              name: 'accessToken',
              description: '영구 System User access token입니다.'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: '유일한 모드입니다. WhatsApp은 1:1 채팅만 전달하며 모든 메시지가 Agent를 지목합니다.'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'identity 매핑, 답장, 플랫폼 제한',
      summary: 'WhatsApp 사용자가 계정이 되는 방식과 Agent가 사용할 수 없는 WhatsApp 기능을 확인하려면 펼치세요.',
      steps: [
        {
          title: 'WhatsApp 사용자가 계정이 되는 방식 확인',
          body: [
  ...
  },
  {
    ...
    alert: {
      title: 'Email은 일부 Ankole 기능을 제한합니다',
      body: [
      ...
      steps: [
        {
          ...
          caution: '이 메일함을 다른 메일 클라이언트에서 열지 마세요. 다른 클라이언트가 읽음으로 표시한 메시지는 Agent에 보이지 않습니다.'
        },
        {
          title: '서버 설정 수집',
          body: [
        ...
        },
        {
          title: 'Console 필드 수집',
          fields: [
            { name: 'address', value: 'agent@example.com', description: '메일함 주소입니다. 답장은 이 주소에서 발송됩니다.' },
            { name: 'displayName', value: 'Ankole Agent', description: '발신 메일의 보낸 사람 이름입니다.' },
            { name: 'imapHost', value: 'imap.example.com', description: 'IMAP 서버 호스트입니다.' },
            { name: 'imapPort', value: '993', description: 'IMAP 포트입니다. Ankole은 implicit TLS를 사용합니다.' },
            { name: 'smtpHost', value: 'smtp.example.com', description: 'SMTP 서버 호스트입니다.' },
            { name: 'smtpPort', value: '587', description: 'SMTP 포트입니다. STARTTLS에는 587을, TLS에는 465를 사용하세요.' },
            { name: 'smtpSecurity', value: 'starttls', description: 'SMTP 포트에 맞는 starttls 또는 tls입니다.' },
            { name: 'username', description: '로그인 이름이며 보통 메일함 주소입니다. 하나의 IMAP 호스트와 username 조합은 활성화된 라우팅 규칙 하나에만 속할 수 있습니다.' },
            { name: 'password', description: '메일함 비밀번호 또는 앱 비밀번호입니다. Ankole은 이를 암호화하여 저장합니다.' },
            { name: 'senderAuthentication', value: 'dmarc', description: 'dmarc를 유지하세요. 외부 메일을 받지 않는 사설 메일 서버에서만 none으로 설정하세요.' }
          ]
        },
        {
          title: '테스트 이메일 전송',
    ...
    advanced: {
      title: '발신자 identity, 발신자 인증, thread',
      summary: '이메일 발신자가 알려진 계정이 되는 방식과 Ankole이 thread와 대량 메일을 처리하는 방식을 확인하려면 펼치세요.',
      steps: [
        {
          title: '이메일 발신자가 계정이 되는 방식 확인',
          body: [
