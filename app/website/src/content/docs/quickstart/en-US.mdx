...
export const modelAdvanced = {
  title: 'Optional Agent profiles and Brain models',
  summary: 'Configure Agent capability profiles only where needed. Brain models apply to the whole instance.',
  steps: [
    {
    ...
    {
      title: 'Configure Brain models for the instance',
      body: [
        'Open Console → AppConfigure → Brain. These settings apply to every Agent and do not belong to an Agent profile.'
      ],
      fields: [
        {
        ...
        {
          name: 'brain.web_fetch_model',
          description: 'Fetches readable content for URL Sources.'
        },
        {
          name: 'brain.extraction_model',
          description: 'Extracts knowledge from Signal conversations and Sources.'
        },
        {
          name: 'brain.dreaming_model',
          description: 'Consolidates knowledge and supports model-dependent maintenance.'
        }
      ],
      links: [
