...
export const modelAdvanced = {
  title: 'Optional Agent profiles and Brain maintenance',
  summary: 'Configure Agent capability profiles only where needed. Brain keeps retrieval models instance-wide.',
  steps: [
    {
      title: 'Add optional Agent capability profiles',
      fields: [
        {
          name: 'Background Agent Jobs',
          description:
            'Uses the coding profile for durable Background Agent Jobs. Normal conversations do not select it because a message contains a lot of code.'
        },
        {
    ...
    {
      title: 'Select the Brain maintainer and retrieval models',
      body: [
      ...
      fields: [
        {
          ...
          description:
            'Uses the selected Agent’s light profile for extraction, heavy for Dreaming, and web_fetch for URL Sources. Missing web_fetch falls back to local ankole-browser.'
        },
        {
          name: 'brain.embedding_model',
          description: 'Enables vector retrieval. Select a Provider and model, and enter its embedding dimensions.'
        },
        {
          name: 'brain.rerank_model',
          description: 'Reranks fused search results. Leave it empty to keep the fusion order.'
        }
      ],
      links: [
        { label: 'Brain guide', href: '../brain/' },
        { label: 'AppConfigure reference', href: '../app-configuration/' }
      ]
    }
  ]
}
...
export const channelTabs = [
  {
    ...
    basic: {
      ...
      steps: [
        ...
        {
          title: 'Subscribe to chat and channel-state events',
          body: [
          ...
          copyItems: [
            ...
            { value: 'message.channels', description: 'Receive public-channel messages' },
            { value: 'message.groups', description: 'Receive private-channel messages' },
            { value: 'message.im', description: 'Receive direct messages' },
            { value: 'message.mpim', description: 'Receive multi-person direct messages' },
            { value: 'reaction_added', description: 'Receive added reactions' },
            { value: 'reaction_removed', description: 'Receive removed reactions' },
            { value: 'member_joined_channel', description: 'Sync members who join a channel' },
            { value: 'member_left_channel', description: 'Sync members who leave a channel' },
            { value: 'channel_rename', description: 'Sync channel renames' },
            { value: 'group_rename', description: 'Sync private-channel renames' },
            { value: 'channel_deleted', description: 'Sync channel deletion' },
            { value: 'channel_archive', description: 'Sync channel archival' }
          ]
        },
        {
        ...
        {
          title: 'Enable Slack-native interactivity',
          body: [
        ...
        {
          title: 'Grant the complete chat scopes and install the app',
          body: [
          ...
          copyItems: [
            { value: 'app_mentions:read', description: 'Read messages that mention the bot' },
            { value: 'channels:read', description: 'Sync public channels and their members' },
            { value: 'channels:history', description: 'Read public-channel messages and reconcile replies' },
            { value: 'groups:read', description: 'Sync private channels and their members' },
            { value: 'groups:history', description: 'Read private-channel messages and reconcile replies' },
            { value: 'im:read', description: 'Sync direct-message conversations' },
            { value: 'im:history', description: 'Read direct messages and reconcile replies' },
            { value: 'mpim:read', description: 'Sync multi-person direct messages and their members' },
            { value: 'mpim:history', description: 'Read multi-person direct messages and reconcile replies' },
            { value: 'chat:write', description: 'Send, update, and delete bot messages' },
            { value: 'reactions:read', description: 'Receive reaction changes' },
            { value: 'reactions:write', description: 'Add and remove reactions' },
            { value: 'files:read', description: 'Read files attached to messages' },
            { value: 'files:write', description: 'Upload files sent by the Agent' },
            { value: 'users:read', description: 'Identify channel members and exclude bot accounts' }
          ],
          caution: 'After a scope change, reinstall the app to the workspace and write the new Bot Token to Ankole.'
        },
        {
    ...
    advanced: {
      title: 'Message policy, subject mapping, and Slack as IdP',
      summary: 'Slack delivers events, but the signal routing rule still decides how Ankole handles unaddressed messages.',
      steps: [
        {
          title: 'Choose the policy for messages that do not mention the Agent',
          body: [
        ...
        {
          title: 'Add identity permissions when one app also serves as the Slack IdP',
          body: ['Use a separate IdP app in production. If one app must serve both roles, add the Bot scopes and directory events below.'],
          copyItems: [
            { value: 'users:read.email', description: 'Sync member email addresses' },
            { value: 'usergroups:read', description: 'Sync user groups and their members' },
            { value: 'team_join', description: 'Receive member-join events' },
            { value: 'user_change', description: 'Receive member-profile changes' },
            { value: 'subteam_created', description: 'Receive user-group creation' },
            { value: 'subteam_updated', description: 'Receive user-group updates' },
            { value: 'subteam_members_changed', description: 'Receive user-group membership changes' }
          ]
        },
        {
  ...
  },
  {
    ...
    basic: {
      ...
      steps: [
        ...
        {
          title: 'Import the complete chat scopes',
          body: [
  ...
  "scopes": {
    ...
    "user": []
        ...
        {
          title: 'Choose long connection and add the implemented events',
          body: [
          ...
          copyItems: [
            ...
            { value: 'im.message.recalled_v1', description: 'Receive message recall events' },
            { value: 'im.message.reaction.created_v1', description: 'Receive added reactions' },
            { value: 'im.message.reaction.deleted_v1', description: 'Receive removed reactions' },
            { value: 'im.chat.member.bot.added_v1', description: 'Sync rooms that add the bot' },
            { value: 'im.chat.member.bot.deleted_v1', description: 'Sync rooms that remove the bot' },
            { value: 'im.chat.member.user.added_v1', description: 'Sync members who join a room' },
            { value: 'im.chat.member.user.deleted_v1', description: 'Sync members who leave a room' },
            { value: 'im.chat.updated_v1', description: 'Sync room changes' },
            { value: 'im.chat.disbanded_v1', description: 'Sync room deletion' },
            { value: 'card.action.trigger', description: 'Receive interactive-card actions' }
          ]
        },
        {
    ...
    advanced: {
      ...
      steps: [
        ...
        {
          title: 'Use one Lark app for each enabled binding',
          bullets: [
            'One Agent can enable several Lark bindings.',
            'Each enabled binding must use a different domain and appID pair.'
          ],
          body: ['Create a separate Lark or Feishu app for each binding. A disabled binding releases its app.']
        }
      ]
    }
  },
  {
    ...
    advanced: {
      ...
      steps: [
        ...
        {
          title: 'Lay out the components for each card state',
          body: [
  ...
  },
  {
    ...
    prerequisites: ['A Telegram account that can talk to @BotFather', 'A test private chat or group'],
    basic: {
      ...
      steps: [
        ...
        {
          title: 'Let the bot read group messages',
          body: [
          ...
          fields: [
            {
              name: 'botToken',
              value: '123456789:AA…',
              description: 'The bot token from @BotFather. One token can belong to only one enabled routing rule.'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: 'Start here. A direct message, an @-mention, a /command@bot, or a reply to the bot addresses the Agent.'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'Identity mapping, forum topics, and platform limits',
      summary: 'Expand to map Telegram users to accounts and to learn which Telegram features the Agent cannot use.',
      steps: [
        {
          title: 'Map Telegram users to accounts',
          body: [
        ...
        {
          title: 'Know how conversations map to sessions',
          bullets: [
        ...
        {
          title: 'Respect the platform limits',
          bullets: [
        ...
        {
          title: 'Use a separate bot for each Agent',
          body: ['One bot token can be bound to only one enabled routing rule. Create another bot in @BotFather for each additional Agent.']
        }
      ]
    }
  },
  {
    ...
    basic: {
      title: 'Prepare a Discord bot',
      steps: [
        {
          title: 'Create the application and its bot',
          body: [
        ...
        },
        {
          ...
          caution: 'Server Members Intent and Presence Intent are not required. An application in more than 100 servers needs Discord verification before it can keep the message content intent.'
        },
        {
          title: 'Invite the bot to the server',
          body: [
          ...
          copyItems: [
            { value: 'View Channels', description: 'See the channels the bot is allowed into' },
            { value: 'Send Messages', description: 'Post Agent replies' },
            { value: 'Send Messages in Threads', description: 'Reply inside a thread' },
            { value: 'Read Message History', description: 'Reply to and edit earlier messages' },
            { value: 'Attach Files', description: 'Upload files sent by the Agent' },
            { value: 'Add Reactions', description: 'Add and remove reactions' }
          ]
        },
        {
        ...
        },
        {
          ...
          fields: [
            {
              name: 'botToken',
              description: 'The bot token from the Bot page. One token can belong to only one enabled routing rule.'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: 'Start here. A direct message, an @-mention, or a reply to the bot addresses the Agent.'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'Identity mapping, threads, and platform limits',
      summary: 'Expand to map Discord users to accounts and to learn which Discord features the Agent cannot use.',
      steps: [
        {
          title: 'Map Discord users to accounts',
          body: [
        ...
        {
          title: 'Use a separate bot for each Agent',
          body: ['One bot token can be bound to only one enabled routing rule. Create another application for each additional Agent.']
        }
      ]
    }
  },
  {
    ...
    alert: {
      title: 'LINE limits some Ankole features',
      body: [
    ...
    basic: {
      title: 'Prepare a LINE Official Account',
      steps: [
        {
          title: 'Create the Messaging API channel and collect its credentials',
          body: [
        ...
        {
          title: 'Create the routing rule before you verify the webhook',
          body: [
        ...
        {
          title: 'Set the webhook URL and verify it',
          code: [
            {
              language: 'text',
        ...
        {
          title: 'Let the bot answer alone',
          body: [
        ...
        },
        {
          ...
          fields: [
            {
              name: 'channelId',
              description: 'The Messaging API Channel ID. One channel can belong to only one enabled routing rule.'
            },
            {
              name: 'channelSecret',
              description: 'The Channel secret from Basic settings. Ankole uses it to verify webhook signatures.'
            },
            {
              name: 'channelAccessToken',
              description: 'A long-lived channel access token from the Messaging API tab.'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: 'Start here. LINE delivers every group message, so observe_all and may_intervene also work without extra permissions.'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'Identity mapping, group replies, and platform limits',
      summary: 'Expand to map LINE users to accounts and to learn how the Agent behaves in groups.',
      steps: [
        {
          title: 'Map LINE users to accounts',
          body: [
        ...
        {
          title: 'Know how the Agent behaves in groups',
          bullets: [
        ...
        {
          title: 'Use a separate channel for each Agent',
          body: ['One Messaging API channel can belong to only one enabled routing rule. Create another channel for each additional Agent.']
        }
      ]
    }
  },
  {
    ...
    alert: {
      title: 'WhatsApp limits some Ankole features',
      body: [
    ...
    basic: {
      title: 'Prepare a WhatsApp Business phone number',
      steps: [
        {
          title: 'Connect the WhatsApp product and collect the identifiers',
          body: [
        ...
        {
          title: 'Issue a permanent System User token',
          body: [
        ...
        {
          title: 'Create the routing rule before you verify the callback',
          body: [
        ...
        {
          title: 'Set the callback URL and subscribe to messages',
          code: [
            {
              language: 'text',
        ...
        },
        {
          ...
          fields: [
            {
              name: 'appId',
              description: 'The Meta App ID. Several phone numbers of one App can each serve their own Agent, and their rules must share the same App secret and verify token.'
            },
            {
              name: 'appSecret',
              description: 'The App secret from App settings → Basic. Ankole uses it to verify webhook signatures.'
            },
            {
              name: 'verifyToken',
              description: 'A value you choose. Enter the same value in the Meta callback configuration.'
            },
            {
              name: 'phoneNumberId',
              description: 'The Phone number ID from WhatsApp → API Setup. One number can belong to only one enabled routing rule.'
            },
            {
              name: 'accessToken',
              description: 'The permanent System User access token.'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: 'The only mode. WhatsApp delivers one-to-one chats only, and every message addresses the Agent.'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'Identity mapping, replies, and platform limits',
      summary: 'Expand to learn how WhatsApp users become accounts and which WhatsApp features the Agent cannot use.',
      steps: [
        {
          title: 'Know how WhatsApp users become accounts',
          body: [
        ...
        {
          title: 'Know how the Agent replies',
          bullets: [
        ...
        {
          title: 'Respect the customer service window',
          body: [
        ...
        {
          title: 'Keep a rule on its phone number',
          body: [
  ...
  },
  {
    ...
    alert: {
      title: 'Email limits some Ankole features',
      body: [
    ...
    basic: {
      title: 'Prepare a dedicated mailbox',
      steps: [
        {
          title: 'Create the mailbox and its password',
          body: [
          ...
          caution: 'Do not open this mailbox in any other mail client. A message that another client marks as read is invisible to the Agent.'
        },
        {
          title: 'Collect the server settings',
          body: [
        ...
        },
        {
          title: 'Collect the Console fields',
          fields: [
            { name: 'address', value: 'agent@example.com', description: 'The mailbox address. Replies are sent from it.' },
            { name: 'displayName', value: 'Ankole Agent', description: 'The sender name on outbound mail.' },
            { name: 'imapHost', value: 'imap.example.com', description: 'IMAP server host.' },
            { name: 'imapPort', value: '993', description: 'IMAP port. Ankole uses implicit TLS.' },
            { name: 'smtpHost', value: 'smtp.example.com', description: 'SMTP server host.' },
            { name: 'smtpPort', value: '587', description: 'SMTP port. Use 587 with STARTTLS or 465 with TLS.' },
            { name: 'smtpSecurity', value: 'starttls', description: 'starttls or tls, matching the SMTP port.' },
            { name: 'username', description: 'The login name, usually the mailbox address. One IMAP host and username pair can belong to only one enabled routing rule.' },
            { name: 'password', description: 'The mailbox password or app password. Ankole stores it encrypted.' },
            { name: 'senderAuthentication', value: 'dmarc', description: 'Keep dmarc. Set none only for a private mail server that admits no outside mail.' }
          ]
        },
        {
    ...
    advanced: {
      title: 'Sender identity, sender authentication, and threads',
      summary: 'Expand to learn how an email sender becomes a known account and how Ankole treats threads and bulk mail.',
      steps: [
        {
          title: 'Know how email senders become accounts',
          body: [
        ...
        {
          title: 'Understand sender authentication',
          body: [
        ...
        {
          title: 'Know how threads and bulk mail are handled',
          bullets: [
...
export const signalAdvanced = {
  title: 'Group behavior and subject namespaces',
  summary: 'The safe first binding replies only when addressed.',
  steps: [
    {
