...
export const modelAdvanced = {
  title: '可选 Agent 档案和 Brain 模型',
  summary: 'Agent 能力按需配置；Brain 模型对整个实例生效。',
  steps: [
    {
    ...
    {
      title: '为实例配置 Brain 模型',
      body: ['打开 Console → 系统配置 → Brain。这些设置对所有 Agent 生效，不属于 Agent 档案。'],
      fields: [
        {
        ...
        },
        {
          ...
          description: '为 URL Source 抓取可读正文。'
        },
        {
          name: 'brain.extraction_model',
          description: '从 Signal 会话和 Source 中提取知识。'
        },
        {
          name: 'brain.dreaming_model',
          description: '汇总知识，并支持依赖模型的维护任务。'
        }
      ],
      links: [
