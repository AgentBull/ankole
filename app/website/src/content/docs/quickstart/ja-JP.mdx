...
export const modelAdvanced = {
  title: '任意の Agent profile と Brain モデル',
  summary: 'Agent の能力 profile は必要な場合だけ設定します。Brain モデルはインスタンス全体に適用されます。',
  steps: [
    {
    ...
    {
      title: 'インスタンスの Brain モデルを設定する',
      body: [
        'Console → AppConfigure → Brain を開きます。これらの設定はすべての Agent に適用され、Agent profile には含まれません。'
      ],
      fields: [
        {
        ...
        },
        {
          ...
          description: 'URL Source の読み取り可能な本文を取得します。'
        },
        {
          name: 'brain.extraction_model',
          description: 'Signal の会話と Source から知識を抽出します。'
        },
        {
          name: 'brain.dreaming_model',
          description: '知識を統合し、モデルが必要な保守タスクを実行します。'
        }
      ],
      links: [
