...
export const modelAdvanced = {
  title: '任意の Agent profile と Brain メンテナンス',
  summary: 'Agent の能力 profile は必要な場合だけ設定します。Brain は検索モデルだけをインスタンス全体で保持します。',
  steps: [
    {
      title: '任意の Agent 能力 profile を追加する',
      fields: [
        {
          name: 'Background Agent Jobs',
          description:
            'coding profile を使って、永続的な Background Agent Jobs を実行します。メッセージにコードが多くても、通常の会話はこの profile を選びません。'
        },
        {
    ...
    {
      title: 'Brain メンテナンス Agent と検索モデルを選択する',
      body: [
      ...
      fields: [
        {
          ...
          description:
            '選択した Agent の light profile で知識を抽出し、heavy profile で Dreaming を実行し、web_fetch profile で URL Source を取得します。web_fetch が未設定の場合はローカルの ankole-browser を使います。'
        },
        {
          name: 'brain.embedding_model',
          description: 'ベクトル検索を有効にします。Provider とモデルを選び、embedding の次元数を入力します。'
        },
        {
          name: 'brain.rerank_model',
          description: '融合した検索結果を rerank します。空の場合は融合後の順序を保ちます。'
        }
      ],
      links: [
        { label: 'Brain ガイド', href: '../brain/' },
        { label: 'AppConfigure リファレンス', href: '../app-configuration/' }
      ]
    }
  ]
}
export const channelTabs = [
  ...
  "scopes": {
    ...
    advanced: {
      ...
      steps: [
        ...
        {
          title: '有効な binding ごとに 1 つの Lark アプリを使う',
          bullets: [
            '1 つの Agent で複数の Lark binding を有効にできます。',
            '有効な binding ごとに異なる domain と appID の組み合わせが必要です。'
          ],
          body: ['binding ごとに別の Lark または Feishu アプリを作成してください。無効な binding はそのアプリを解放します。']
        }
      ]
    }
  },
  ...
  },
  {
    ...
    prerequisites: ['@BotFather と会話できる Telegram アカウント', 'テスト用のプライベートチャットまたはグループ'],
    basic: {
      title: 'Telegram bot を準備する',
      steps: [
        {
          title: '@BotFather で bot を作成する',
          body: [
            '@BotFather に /newbot を送信し、表示名と bot で終わるユーザー名を選び、BotFather が返す token をコピーしてください。この token は routing ルールに必要な唯一の credential です。'
          ]
        },
        {
          title: 'bot にグループメッセージを読ませる',
          body: [
          ...
          fields: [
            {
              name: 'botToken',
              value: '123456789:AA…',
              description: '@BotFather から取得した bot token。1 つの token は有効な routing ルール 1 つにのみ属せます。'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: 'ここから始めてください。ダイレクトメッセージ、@ メンション、/command@bot、または bot への返信が Agent 宛になります。'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'identity マッピング、フォーラムトピック、プラットフォームの制限',
      summary: '展開すると、Telegram ユーザーをアカウントにマッピングする方法と、Agent が使えない Telegram の機能を確認できます。',
      steps: [
        {
          title: 'Telegram ユーザーをアカウントにマッピングする',
          body: [
        ...
        {
          title: 'Agent ごとに別の bot を使用する',
          body: ['1 つの bot token は有効な routing ルール 1 つにのみバインドできます。追加の Agent ごとに @BotFather で別の bot を作成してください。']
        }
      ]
    }
  },
  {
    ...
    basic: {
      title: 'Discord bot を準備する',
      steps: [
        {
          title: 'アプリケーションとその bot を作成する',
          body: [
        ...
        },
        {
          ...
          caution: 'Server Members Intent と Presence Intent は不要です。100 を超えるサーバーに参加しているアプリケーションは、メッセージ内容の intent を維持するために Discord の認証が必要です。'
        },
        {
          ...
          copyItems: [
            { value: 'View Channels', description: 'bot が許可されたチャンネルを見る' },
            { value: 'Send Messages', description: 'Agent の返信を投稿する' },
            { value: 'Send Messages in Threads', description: 'スレッド内で返信する' },
            { value: 'Read Message History', description: '以前のメッセージに返信し、編集する' },
            { value: 'Attach Files', description: 'Agent が送信するファイルをアップロードする' },
            { value: 'Add Reactions', description: 'リアクションを追加および削除する' }
          ]
        },
        {
          title: 'Interactions Endpoint URL を空のままにする',
          body: [
        ...
        },
        {
          ...
          fields: [
            {
              name: 'botToken',
              description: 'Bot ページから取得した bot token。1 つの token は有効な routing ルール 1 つにのみ属せます。'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: 'ここから始めてください。ダイレクトメッセージ、@ メンション、または bot への返信が Agent 宛になります。'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'identity マッピング、スレッド、プラットフォームの制限',
      summary: '展開すると、Discord ユーザーをアカウントにマッピングする方法と、Agent が使えない Discord の機能を確認できます。',
      steps: [
        {
          title: 'Discord ユーザーをアカウントにマッピングする',
          body: [
        ...
        {
          title: 'Agent ごとに別の bot を使用する',
          body: ['1 つの bot token は有効な routing ルール 1 つにのみバインドできます。追加の Agent ごとに別のアプリケーションを作成してください。']
        }
      ]
    }
  },
  {
    ...
    alert: {
      title: 'LINE は Ankole の一部の機能を制限します',
      body: [
    ...
    basic: {
      title: 'LINE Official Account を準備する',
      steps: [
        {
          title: 'Messaging API channel を作成し、その credential を収集する',
          body: [
        ...
        {
          title: 'webhook を検証する前に routing ルールを作成する',
          body: [
        ...
        },
        {
          ...
          fields: [
            {
              name: 'channelId',
              description: 'Messaging API の Channel ID。1 つの channel は有効な routing ルール 1 つにのみ属せます。'
            },
            {
              name: 'channelSecret',
              description: 'Basic settings の Channel secret。Ankole は webhook の署名検証に使用します。'
            },
            {
              name: 'channelAccessToken',
              description: 'Messaging API タブで発行した長期の channel access token。'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: 'ここから始めてください。LINE はすべてのグループメッセージを配信するため、observe_all と may_intervene も追加の権限なしで機能します。'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'identity マッピング、グループでの返信、プラットフォームの制限',
      summary: '展開すると、LINE ユーザーをアカウントにマッピングする方法と、グループでの Agent の動作を確認できます。',
      steps: [
        {
          title: 'LINE ユーザーをアカウントにマッピングする',
          body: [
        ...
        {
          title: 'Agent ごとに別の channel を使用する',
          body: ['1 つの Messaging API channel は有効な routing ルール 1 つにのみ属せます。追加の Agent ごとに別の channel を作成してください。']
        }
      ]
    }
  },
  {
    ...
    alert: {
      title: 'WhatsApp は Ankole の一部の機能を制限します',
      body: [
    ...
    basic: {
      title: 'WhatsApp Business の電話番号を準備する',
      steps: [
        {
          title: 'WhatsApp product を接続し、識別子を収集する',
          body: [
        ...
        {
          title: '無期限の System User token を発行する',
          body: [
        ...
        {
          title: 'コールバックを検証する前に routing ルールを作成する',
          body: [
        ...
        {
          title: 'コールバック URL を設定し、messages を購読する',
          code: [
            {
              language: 'text',
        ...
        },
        {
          ...
          fields: [
            {
              name: 'appId',
              description: 'Meta App ID。1 つの App の複数の電話番号がそれぞれ別の Agent を担当できます。それらのルールは同じ App secret と verify token を共有する必要があります。'
            },
            {
              name: 'appSecret',
              description: 'App settings → Basic の App secret。Ankole は webhook の署名検証に使用します。'
            },
            {
              name: 'verifyToken',
              description: '自分で決める値。Meta のコールバック設定に同じ値を入力してください。'
            },
            {
              name: 'phoneNumberId',
              description: 'WhatsApp → API Setup の Phone number ID。1 つの番号は有効な routing ルール 1 つにのみ属せます。'
            },
            {
              name: 'accessToken',
              description: '無期限の System User access token。'
            },
            {
              name: 'group_message_mode',
              value: 'addressed_only',
              description: '唯一のモードです。WhatsApp は 1 対 1 のチャットのみを配信し、すべてのメッセージが Agent 宛になります。'
            }
          ]
        }
      ]
    ...
    advanced: {
      title: 'identity マッピング、返信、プラットフォームの制限',
      summary: '展開すると、WhatsApp ユーザーがアカウントになる方法と、Agent が使用できない WhatsApp の機能を確認できます。',
      steps: [
        {
          title: 'WhatsApp ユーザーがアカウントになる方法を知る',
          body: [
  ...
  },
  {
    ...
    alert: {
      title: 'Email は Ankole の一部の機能を制限します',
      body: [
    ...
    basic: {
      title: '専用のメールボックスを準備する',
      steps: [
        {
          title: 'メールボックスとそのパスワードを作成する',
          body: [
            'Agent だけが使用するメールボックスを作成し、IMAP と SMTP を有効にしてください。プロバイダーが要求する場合は、アカウントのパスワードではなく Ankole 用のアプリパスワードを作成してください。'
          ],
          caution: 'このメールボックスを他のメールクライアントで開かないでください。他のクライアントが既読にしたメッセージは Agent から見えません。'
        },
        {
          title: 'サーバー設定を収集する',
          body: [
        ...
        },
        {
          title: 'Console のフィールドを収集する',
          fields: [
            { name: 'address', value: 'agent@example.com', description: 'メールボックスのアドレス。返信はここから送信されます。' },
            { name: 'displayName', value: 'Ankole Agent', description: '送信メールの送信者名。' },
            { name: 'imapHost', value: 'imap.example.com', description: 'IMAP サーバーのホスト。' },
            { name: 'imapPort', value: '993', description: 'IMAP のポート。Ankole は implicit TLS を使用します。' },
            { name: 'smtpHost', value: 'smtp.example.com', description: 'SMTP サーバーのホスト。' },
            { name: 'smtpPort', value: '587', description: 'SMTP のポート。STARTTLS では 587、TLS では 465 を使用してください。' },
            { name: 'smtpSecurity', value: 'starttls', description: 'SMTP のポートに合わせて starttls または tls。' },
            { name: 'username', description: 'ログイン名。通常はメールボックスのアドレスです。1 組の IMAP ホストとユーザー名は有効な routing ルール 1 つにのみ属せます。' },
            { name: 'password', description: 'メールボックスのパスワードまたはアプリパスワード。Ankole は暗号化して保存します。' },
            { name: 'senderAuthentication', value: 'dmarc', description: 'dmarc のままにしてください。none は、外部からのメールを受け付けないプライベートなメールサーバーの場合にのみ設定してください。' }
          ]
        },
        {
          title: 'テストメールを送信する',
    ...
    advanced: {
      title: '送信者の identity、送信者認証、スレッド',
      summary: '展開すると、メールの送信者が既知のアカウントになる方法と、Ankole がスレッドと一括メールを扱う方法を確認できます。',
      steps: [
        {
          title: 'メールの送信者がアカウントになる方法を知る',
          body: [
...
export const signalAdvanced = {
  title: 'グループでの動作と identity mapping',
  summary: '最初の設定では、Agent 宛のメッセージだけに返信させてください。',
  steps: [
    {
