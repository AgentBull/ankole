...
Read [Worker CLI capabilities](../cli-capabilities/) for the Automation Job SDK, test boundary, failure rules, and commands. Cancel the Cron, Checkback, or webhook endpoint before you cancel its automation job.
