...
<DocsArchitectureDiagram lang="ko-KR" />
...
사용자 관점에서 이 시스템은 장기 memory이고, 저장, Dreaming, 작성 권한은 Brain이 소유합니다.
...
논리적 경계는 모든 형태에서 같습니다. 인스턴스에는 컨트롤 플레인이 하나 있으며 Worker를 수평으로 추가할 수 있습니다. 전체 절차는 [빠른 시작](../quickstart/#deployment)을 참조하십시오.
