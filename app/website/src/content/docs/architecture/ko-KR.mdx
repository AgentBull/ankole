...
[Brain](../brain/)은 “지금 세계가 어떤 상태인가”를 담당합니다. [Skill Lessons](../skill-lessons/)는 반복되는 작업 증거에서 Agent가 학습한 절차 가드레일을 보관합니다. 해당 Skill과 함께 제공되지만 Skill 원본을 고쳐 쓰지 않으며, 더 이상 적용되지 않으면 폐기됩니다.
