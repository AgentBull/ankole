...
Slack、Microsoft Teams 和飞书 / Lark 支持以上三种模式。钉钉和企业微信只能处理明确提及机器人的群消息，因此 Console 只会提供第一种模式。企业微信的限制远不止这一条（无法撤回、群聊收不到文件、Agent 不能主动开启会话等），我们不建议把它作为首选渠道，详见[企业微信适配器的限制](../adapters-wecom/)。
...
- **企业微信收发异常**：先对照[企业微信适配器的限制](../adapters-wecom/)确认不是平台限制——常见的有机器人非超管创建、可信 IP 未配置、会话未被用户先激活。
...
钉钉规则若要用流式卡片回复，需要先在钉钉卡片平台搭一份 AI 卡片模板，见[钉钉 AI 卡片回复](../dingtalk-ai-card/)。
