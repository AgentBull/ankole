...
/**
 * The react-markdown pipeline behind `MarkdownBody`. It lives in its own
 * module as the target of a dynamic import, so the parser stack loads only
 * when a conversation or job detail actually renders Markdown.
 *
 * react-markdown escapes raw HTML by default, so untrusted IM-sourced text
 * cannot inject markup into the console. Element styles follow the console's
 * Carbon type scale: 14px body text, hairline table rules, and layer-01 code
 * surfaces.
 */
