...
export class OpenAIImageModel implements ImageModelV4 {
  ...
  static [WORKFLOW_DESERIALIZE](options: { modelId: OpenAIImageModelId; config: OpenAIImageModelConfig }) {
...
function distributeTokenDetails(
  details: { image_tokens?: number | null; text_tokens?: number | null } | null | undefined,
  index: number,
  total: number
...
async function fileToBlob(file: ImageModelV4File | undefined): Promise<Blob | undefined> {
