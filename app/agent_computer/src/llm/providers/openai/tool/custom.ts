// @ts-nocheck
import { createProviderDefinedToolFactory, lazySchema, zodSchema } from '@/llm/provider-utils'
...
export const customTool = (args: Parameters<typeof customToolFactory>[0]) => customToolFactory(args)
