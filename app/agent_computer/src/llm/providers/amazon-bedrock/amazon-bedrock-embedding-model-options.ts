...
export const amazonBedrockEmbeddingModelOptionsSchema = z.object({
   ...
   */
  embeddingDimension: z.union([z.literal(256), z.literal(384), z.literal(1024), z.literal(3072)]).optional(),
   ...
   */
  outputDimension: z.union([z.literal(256), z.literal(512), z.literal(1024), z.literal(1536)]).optional()
})

export type AmazonBedrockEmbeddingModelOptions = z.infer<typeof amazonBedrockEmbeddingModelOptionsSchema>
