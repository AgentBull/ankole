...
import { asSchema } from '@/llm/provider-utils'
import { anthropicTools, prepareTools as prepareAnthropicTools } from '@/llm/providers/anthropic/internal'
import type { AmazonBedrockTool, AmazonBedrockToolConfiguration } from './amazon-bedrock-api-types'
...
export async function prepareTools({
  ...
  let amazonBedrockToolChoice: AmazonBedrockToolConfiguration['toolChoice'] = undefined
  ...
  const toolConfig: AmazonBedrockToolConfiguration =
    amazonBedrockTools.length > 0 ? { tools: amazonBedrockTools, toolChoice: amazonBedrockToolChoice } : {}
