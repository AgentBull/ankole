// @ts-nocheck
import { anthropicTools } from '@/llm/providers/anthropic/internal'
import type { EmbeddingModelV4, ImageModelV4, LanguageModelV4, ProviderV4, RerankingModelV4 } from '@/llm/provider'
import {
  generateId,
  loadOptionalSetting,
  loadSetting,
 ...
 */
export function createAmazonBedrock(options: AmazonBedrockProviderSettings = {}): AmazonBedrockProvider {
