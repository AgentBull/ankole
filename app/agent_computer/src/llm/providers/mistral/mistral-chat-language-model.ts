...
import { mistralLanguageModelChatOptions, type MistralChatModelId } from './mistral-chat-language-model-options'
...
export class MistralChatLanguageModel implements LanguageModelV4 {
  ...
  static [WORKFLOW_DESERIALIZE](options: { modelId: MistralChatModelId; config: MistralChatConfig }) {
  ...
  async doStream(options: LanguageModelV4CallOptions): Promise<LanguageModelV4StreamResult> {
    ...
    return {
      stream: response.pipeThrough(
        new TransformStream<ParseResult<z.infer<typeof mistralChatChunkSchema>>, LanguageModelV4StreamPart>({
          start(controller) {
