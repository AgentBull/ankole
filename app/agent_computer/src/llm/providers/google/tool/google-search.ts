...
export type GoogleSearchToolArgs = z.infer<typeof googleSearchToolArgsBaseSchema>

export const googleSearch = createProviderExecutedToolFactory<{}, {}, GoogleSearchToolArgs>({
