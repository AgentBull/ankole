...
export class GoogleJSONAccumulator {
  ...
  processPartialArgs(partialArgs: PartialArg[]): {
    ...
    for (const arg of partialArgs) {
      ...
      if (isStringContinuation) {
        ...
        setNestedValue(this.accumulatedArgs, segments, (existingValue as string) + arg.stringValue)
        delta += escaped
        continue
      }
   ...
   */
  private emitNavigationTo(targetSegments: PathSegment[], arg: PartialArg, valueJson: string): string {
    let fragment = ''
   ...
   */
  private openDownTo(targetContainer: PathSegment[], leafSegment: PathSegment): string {
    let fragment = ''
   ...
   */
  private emitLeaf(leafSegment: PathSegment, arg: PartialArg, valueJson: string): string {
    let fragment = ''
 ...
 */
function hasOwnProperty(obj: Record<string | number, unknown>, key: string | number): boolean {
 ...
 */
function defineOwnProperty(obj: Record<string | number, unknown>, key: string | number, value: unknown): void {
 ...
 * Output: "Lasagna"
 */
function getNestedValue(obj: Record<string, unknown>, segments: Array<string | number>): unknown {
 ...
 */
function setNestedValue(obj: Record<string, unknown>, segments: Array<string | number>, value: unknown): void {
