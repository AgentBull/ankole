// @ts-nocheck
import { createJsonResponseHandler, delay, getFromApi, isAbortError, type FetchFunction } from '@/llm/provider-utils'
import { googleFailedResponseHandler } from '../google-error'
import { cancelGoogleInteraction } from './cancel-google-interaction'
import { googleInteractionsResponseSchema, type GoogleInteractionsResponse } from './google-interactions-api'
import type { GoogleInteractionsStatus } from './google-interactions-prompt'

const TERMINAL_STATUSES: ReadonlySet<GoogleInteractionsStatus | string> = new Set([
  'completed',
  'failed',
  'cancelled',
  'incomplete'
...
export function isTerminalStatus(status: GoogleInteractionsStatus | string | null | undefined): boolean {
