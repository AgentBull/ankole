...
export type GoogleInteractionsThoughtSummaryItem = GoogleInteractionsTextContent | GoogleInteractionsImageContent

export type GoogleInteractionsFunctionResultContent = {
  type: 'function_result'
  call_id: string
  result: string | Array<GoogleInteractionsTextContent | GoogleInteractionsImageContent> | unknown
  name?: string
  is_error?: boolean
  signature?: string
}
...
export type GoogleInteractionsToolChoiceType = 'auto' | 'any' | 'none' | 'validated'
...
export type GoogleInteractionsToolChoice = GoogleInteractionsToolChoiceType | GoogleInteractionsAllowedToolsConfig

export type GoogleInteractionsThinkingLevel = 'minimal' | 'low' | 'medium' | 'high'

export type GoogleInteractionsThinkingSummaries = 'auto' | 'none'

export type GoogleInteractionsResponseModality = 'text' | 'image' | 'audio' | 'video' | 'document'
...
export type GoogleInteractionsNetworkConfig = 'disabled' | { allowlist: Array<GoogleInteractionsNetworkAllowlistEntry> }
 ...
 */
export type GoogleInteractionsBuiltinToolResultContent = GoogleInteractionsBuiltinToolResultStep
