// @ts-nocheck
import { lazySchema, zodSchema, type InferSchema } from '@/llm/provider-utils'
...
const interactionStatusSchema = () =>
  z.enum(['in_progress', 'requires_action', 'completed', 'failed', 'cancelled', 'incomplete'])
...
const annotationSchema = () => {
  ...
  return z.union([urlCitation, fileCitation, placeCitation, z.object({ type: z.string() }).loose()])
}
...
const contentBlockSchema = () => {
  ...
  return z.union([textContent, imageContent, z.object({ type: z.string() }).loose()])
}

export type GoogleInteractionsContentBlock = z.infer<ReturnType<typeof contentBlockSchema>>
...
export type GoogleInteractionsResponse = InferSchema<typeof googleInteractionsResponseSchema>
...
export type GoogleInteractionsEvent = InferSchema<typeof googleInteractionsEventSchema>
