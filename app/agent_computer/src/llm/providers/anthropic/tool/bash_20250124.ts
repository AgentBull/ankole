...
export const bash_20250124_internal = createProviderDefinedToolFactory<Bash20250124Input, {}>({
...
type Bash20250124OptionsWithNullableExecute<OUTPUT> = Omit<Bash20250124Options<OUTPUT>, 'execute'> & {
...
export function bash_20250124<OUTPUT>(
  ...
  if (execute === undefined) {
    ...
    } as Bash20250124Options<Bash20250124DefaultOutput>) as ReturnType<typeof bash_20250124_internal<OUTPUT>>
  }
