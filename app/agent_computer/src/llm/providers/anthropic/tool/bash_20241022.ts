...
export const bash_20241022_internal = createProviderDefinedToolFactory<Bash20241022Input, {}>({
...
type Bash20241022OptionsWithNullableExecute<OUTPUT> = Omit<Bash20241022Options<OUTPUT>, 'execute'> & {
...
export function bash_20241022<OUTPUT>(
  ...
  if (execute === undefined) {
    ...
    } as Bash20241022Options<Bash20241022DefaultOutput>) as ReturnType<typeof bash_20241022_internal<OUTPUT>>
  }
