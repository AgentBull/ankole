// @ts-nocheck
import type { FilesV4, FilesV4UploadFileCallOptions, FilesV4UploadFileResult } from '@/llm/provider'
import {
  combineHeaders,
...
export class AnthropicFiles implements FilesV4 {
  ...
  async uploadFile({ data, mediaType, filename }: FilesV4UploadFileCallOptions): Promise<FilesV4UploadFileResult> {
    ...
    const { value: response } = await postFormDataToApi({
      ...
      successfulResponseHandler: createJsonResponseHandler(anthropicUploadFileResponseSchema),
