// @ts-nocheck
import { TooManyEmbeddingValuesForCallError, type EmbeddingModelV4, type SharedV4Warning } from '@/llm/provider'
import {
  combineHeaders,
...
export class OpenAICompatibleEmbeddingModel implements EmbeddingModelV4 {
  ...
  static [WORKFLOW_DESERIALIZE](options: { modelId: string; config: OpenAICompatibleEmbeddingConfig }) {
