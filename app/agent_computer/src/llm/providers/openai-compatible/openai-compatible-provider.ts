// @ts-nocheck
import type { EmbeddingModelV4, ImageModelV4, LanguageModelV4, ProviderV4 } from '@/llm/provider'
import { withoutTrailingSlash, withUserAgentSuffix, type FetchFunction } from '@/llm/provider-utils'
import {
