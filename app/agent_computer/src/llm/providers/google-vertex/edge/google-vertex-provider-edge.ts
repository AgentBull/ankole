// @ts-nocheck
import { loadOptionalSetting, resolve } from '@/llm/provider-utils'
import {
...
import { generateAuthToken, type GoogleCredentials } from './google-vertex-auth-edge'
...
export function createGoogleVertex(options: GoogleVertexProviderSettings = {}): GoogleVertexProvider {
