// @ts-nocheck
import type { EmbeddingModelV2, EmbeddingModelV3 } from '@/llm/provider'
import { logV2CompatibilityWarning } from '../util/log-v2-compatibility-warning'

export function asEmbeddingModelV3(model: EmbeddingModelV2<string> | EmbeddingModelV3): EmbeddingModelV3 {
