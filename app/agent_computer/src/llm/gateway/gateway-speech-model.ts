// @ts-nocheck
import type { SharedV4ProviderMetadata, SharedV4Warning, SpeechModelV4 } from '@/llm/provider'
import {
  combineHeaders,
...
export class GatewaySpeechModel implements SpeechModelV4 {
  ...
  async doGenerate({
    ...
    headers,
    abortSignal
  }: Parameters<SpeechModelV4['doGenerate']>[0]): Promise<Awaited<ReturnType<SpeechModelV4['doGenerate']>>> {
    ...
    try {
      ...
      return {
        ...
        providerMetadata: responseBody.providerMetadata as SharedV4ProviderMetadata,
        response: {
          timestamp: new Date(),
