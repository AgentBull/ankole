 ...
 */
export function getGatewayRealtimeProtocols(token: string, options?: { teamIdOrSlug?: string }): string[] {
 ...
 */
export function getGatewayRealtimeAuthToken(secWebSocketProtocol: string | null | undefined): string | undefined {
 ...
 */
export function getGatewayRealtimeTeamIdOrSlug(secWebSocketProtocol: string | null | undefined): string | undefined {
  const encoded = findProtocol(secWebSocketProtocol, GATEWAY_TEAM_SUBPROTOCOL_PREFIX)?.slice(
    GATEWAY_TEAM_SUBPROTOCOL_PREFIX.length
  )
...
function findProtocol(secWebSocketProtocol: string | null | undefined, prefix: string): string | undefined {
