...
function isTimeoutError(error: unknown): boolean {
  ...
  if (typeof errorCode === 'string') {
    const undiciTimeoutCodes = ['UND_ERR_HEADERS_TIMEOUT', 'UND_ERR_BODY_TIMEOUT', 'UND_ERR_CONNECT_TIMEOUT']
...
export async function asGatewayError(error: unknown, authMethod?: 'api-key' | 'oidc') {
