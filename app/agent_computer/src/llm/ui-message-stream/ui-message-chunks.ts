...
import { providerMetadataSchema, type ProviderMetadata } from '../types/provider-metadata'
import { jsonValueSchema } from '../types/json-value'
import type { FinishReason } from '../types/language-model'
import type { InferUIMessageData, InferUIMessageMetadata, UIDataTypes, UIMessage } from '../ui/ui-messages'
import type { ValueOf } from '../util/value-of'
import { lazySchema, zodSchema } from '@/llm/provider-utils'

const toolMetadataSchema: z.ZodType<JSONObject> = z.record(z.string(), jsonValueSchema.optional())
    ...
    z.union([
      ...
      z.strictObject({
        type: z.custom<`data-${string}`>(
          (value): value is `data-${string}` => typeof value === 'string' && value.startsWith('data-'),
...
export function isDataUIMessageChunk(chunk: UIMessageChunk): chunk is DataUIMessageChunk<UIDataTypes> {
