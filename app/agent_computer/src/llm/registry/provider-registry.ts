...
> implements ProviderRegistryProvider<PROVIDERS, SEPARATOR> {
  ...
  languageModel<KEY extends keyof PROVIDERS>(id: `${KEY & string}${SEPARATOR}${string}`): LanguageModelV4 {
  ...
  embeddingModel<KEY extends keyof PROVIDERS>(id: `${KEY & string}${SEPARATOR}${string}`): EmbeddingModelV4 {
  ...
  imageModel<KEY extends keyof PROVIDERS>(id: `${KEY & string}${SEPARATOR}${string}`): ImageModelV4 {
  ...
  transcriptionModel<KEY extends keyof PROVIDERS>(id: `${KEY & string}${SEPARATOR}${string}`): TranscriptionModelV4 {
