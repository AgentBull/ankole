// @ts-nocheck
import { TypeValidationError, type JSONValue, type LanguageModelV4CallOptions } from '@/llm/provider'
import { asSchema, resolve, safeParseJSON, safeValidateTypes, type FlexibleSchema } from '@/llm/provider-utils'
      ...
      switch (result.state) {
        ...
        case 'successful-parse': {
          ...
          if (result.state === 'successful-parse') {
            ...
            return potentialMatches.length === 1 ? { partial: potentialMatches[0] as CHOICE } : undefined
          }
        }
      }
    },
