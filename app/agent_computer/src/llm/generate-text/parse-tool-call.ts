// @ts-nocheck
import type { LanguageModelV4ToolCall } from '@/llm/provider'
import {
  asSchema,
  safeParseJSON,
  safeValidateTypes,
...
async function parseProviderExecutedDynamicToolCall(toolCall: LanguageModelV4ToolCall): Promise<DynamicToolCall> {
  const parseResult =
