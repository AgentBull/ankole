 ...
 */
export type LanguageModelCallEndEvent<TOOLS extends ToolSet = ToolSet> = ModelInfo & {
  /** Unique identifier for this generation call, used to correlate events. */
  readonly callId: string
 ...
 */
export type OnLanguageModelCallStartCallback = Callback<LanguageModelCallStartEvent>
 ...
 */
export type OnLanguageModelCallEndCallback<TOOLS extends ToolSet = ToolSet> = Callback<LanguageModelCallEndEvent<TOOLS>>
