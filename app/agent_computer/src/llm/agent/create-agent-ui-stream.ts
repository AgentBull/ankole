// @ts-nocheck
import type { Arrayable, Context, Tool, ToolSet } from '@/llm/provider-utils'
import type {
...
import type { InferUIMessageTools, InferUITools, UIMessage } from '../ui/ui-messages'
...
export async function createAgentUIStream<
  ...
  UI_MESSAGE extends UIMessage<MESSAGE_METADATA, never, InferUITools<TOOLS>> = UIMessage<
    MESSAGE_METADATA,
    never,
    InferUITools<TOOLS>
  >
