// @ts-nocheck
import type { Context, Tool, ToolSet } from '@/llm/provider-utils'
...
import type { InferUIMessageTools, InferUITools, UIMessage } from './ui-messages'
 ...
 * import { DirectChatTransport } from '@/llm';
...
> implements ChatTransport<UI_MESSAGE> {
  ...
  }: DirectChatTransportOptions<CALL_OPTIONS, TOOLS, RUNTIME_CONTEXT, OUTPUT, UI_MESSAGE>) {
    this.agent = agent
  ...
  async sendMessages({
    ...
    } as Parameters<Agent<CALL_OPTIONS, TOOLS, RUNTIME_CONTEXT, OUTPUT>['stream']>[0])
