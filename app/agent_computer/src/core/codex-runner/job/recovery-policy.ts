...
/** Initial local recovery counters for one Job attempt. */
...
// This table owns the local transition policy for Codex failures. Exhausted or
// cross-attempt work returns to the durable control-plane retry path.
