...
// This module is Ankole's durable model abstraction layer. It sits ON TOP of the
// evolved AI SDK layer (everything else under src/ai-gateway-client/) and defines the
...
/** Provider API dialect (e.g. 'open-responses'); selects which AI SDK transport a model speaks. */
export type Api = string
/** Provider kind as stored in installation config (e.g. 'ai-gateway'). */
