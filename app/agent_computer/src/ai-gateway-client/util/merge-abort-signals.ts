import { filterNullable } from '@/ai-gateway-client/provider-utils'
 ...
 */
export function mergeAbortSignals(...signals: (AbortSignal | null | undefined | number)[]): AbortSignal | undefined {
