...
export function createToolNameMapping({
   ...
   */
  tools: Array<LanguageModelFunctionTool | LanguageModelProviderTool> | undefined
  ...
  return {
    toProviderToolName: (customToolName: string) => customToolNameToProviderToolName[customToolName] ?? customToolName,
