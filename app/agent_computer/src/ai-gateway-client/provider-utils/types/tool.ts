import type { JSONValue, JSONObject } from '@/ai-gateway-client/provider'
 ...
 */
type ToolOutputProperties<INPUT, OUTPUT, CONTEXT extends Context | unknown | never> = NeverOptional<
  OUTPUT,
  | {
      /**
...
> = {
   ...
   */
  onInputDelta?: (
    options: { inputTextDelta: string } & ToolExecutionOptions<NoInfer<CONTEXT>>
...
export function tool<INPUT, CONTEXT extends Context>(tool: Tool<INPUT, never, CONTEXT>): Tool<INPUT, never, CONTEXT>
export function tool<OUTPUT, CONTEXT extends Context>(tool: Tool<never, OUTPUT, CONTEXT>): Tool<never, OUTPUT, CONTEXT>
export function tool<CONTEXT extends Context>(tool: Tool<never, never, CONTEXT>): Tool<never, never, CONTEXT>
