import { UnsupportedFunctionalityError, type LanguageModelFilePart } from '@/ai-gateway-client/provider'
 ...
 */
export function resolveFullMediaType({ part }: { part: LanguageModelFilePart }): string {
