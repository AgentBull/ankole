...
import type { ToolExecutionEndEvent, ToolExecutionStartEvent } from '../generate-text/tool-execution-events'
import type {
  RerankEndEvent,
  RerankStartEvent,
...
type OperationStartEvent = GenerateTextStartEvent | EmbedStartEvent | RerankStartEvent

type OperationEndEvent = GenerateTextEndEvent<ToolSet> | EmbedEndEvent | RerankEndEvent
