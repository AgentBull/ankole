import type { Arrayable, Context, InferToolSetContext, ToolSet } from '@/ai-gateway-client/provider-utils'
 ...
 */
export type TelemetryOptions<RUNTIME_CONTEXT extends Context = Context, TOOLS extends ToolSet = ToolSet> = {
  /**
