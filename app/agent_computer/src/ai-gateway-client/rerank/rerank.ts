import type { JSONObject, RerankingModelCallOptions } from '@/ai-gateway-client/provider'
import { createIdGenerator, type ProviderOptions } from '@/ai-gateway-client/provider-utils'
...
export async function rerank<VALUE extends JSONObject | string>({
  ...
  const documentsToSend: RerankingModelCallOptions['documents'] =
