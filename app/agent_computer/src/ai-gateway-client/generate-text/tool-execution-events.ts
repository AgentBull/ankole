import type { InferToolContext, ModelMessage, ToolSet } from '@/ai-gateway-client/provider-utils'
 ...
 */
export type OnToolExecutionStartCallback<TOOLS extends ToolSet = ToolSet> = Callback<ToolExecutionStartEvent<TOOLS>>
 ...
 */
export type OnToolExecutionEndCallback<TOOLS extends ToolSet = ToolSet> = Callback<ToolExecutionEndEvent<TOOLS>>
