 ...
 * In addition to the string statuses, you can also use object statuses with a reason property.
 */
export type ToolApprovalConfiguration<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context | unknown | never> =
  | GenericToolApprovalFunction<TOOLS, InferToolSetContext<TOOLS>, RUNTIME_CONTEXT>
  | {
      [key in keyof TOOLS]?:
        | ToolApprovalStatus
        | SingleToolApprovalFunction<InferToolInput<TOOLS[key]>, InferToolContext<TOOLS[key]>, RUNTIME_CONTEXT>
    }
