import { TypeValidationError, type JSONValue, type LanguageModelCallOptions } from '@/ai-gateway-client/provider'
import {
  asSchema,
  resolve,
  safeParseJSON,
...
export interface Output<OUTPUT = any, PARTIAL = any, ELEMENT = any> {
   ...
   */
  responseFormat: PromiseLike<LanguageModelCallOptions['responseFormat']>
