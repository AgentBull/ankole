import type { Context, InferToolSetContext, ProviderOptions, ToolSet } from '@/ai-gateway-client/provider-utils'
 ...
 */
export type GenerateTextEndEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = {
  /** Unique identifier for this generation call, used to correlate events. */
  readonly callId: string
 ...
 * completes.
 */
export type GenerateTextAbortEvent<TOOLS extends ToolSet = ToolSet, RUNTIME_CONTEXT extends Context = Context> = {
  /** Unique identifier for this generation call, used to correlate events. */
  readonly callId: string
