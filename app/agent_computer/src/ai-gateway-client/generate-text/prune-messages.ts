import type { AssistantModelMessage, ModelMessage, ToolModelMessage } from '@/ai-gateway-client/provider-utils'
    ...
    messages = messages.map((message, messageIndex) => {
      ...
      return {
        ...
        content: message.content.filter(part => {
          ...
          if (
            ((part.type === 'tool-call' || part.type === 'tool-result') && keptToolCallIds.has(part.toolCallId)) ||
