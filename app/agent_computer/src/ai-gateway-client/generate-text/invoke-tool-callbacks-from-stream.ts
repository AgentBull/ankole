import type { Context, ModelMessage, ToolSet } from '@/ai-gateway-client/provider-utils'
import type { LanguageModelStreamPart } from './stream-language-model-call'

export function invokeToolCallbacksFromStream<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context>({
  stream,
  tools,
  stepInputMessages,
  abortSignal,
