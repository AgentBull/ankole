...
import type { CallWarning, FinishReason, LanguageModelResponseMetadata, ProviderMetadata } from '../types'
 ...
 */
export interface GenerateTextResult<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context, OUTPUT extends Output> {
  /**
