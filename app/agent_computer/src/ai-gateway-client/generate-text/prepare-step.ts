 ...
 */
export type PrepareStepFunction<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context = Context> = (options: {
  /**
 ...
 */
export type PrepareStepResult<TOOLS extends ToolSet, RUNTIME_CONTEXT extends Context = Context> =
  | {
      /**
