import type { LanguageModelContent, LanguageModelStreamPart } from '@/ai-gateway-client/provider'
...
export function extractReasoningMiddleware({
  ...
  return {
    wrapGenerate: async ({ doGenerate }) => {
      ...
      const transformedContent: LanguageModelContent[] = []
    ...
    wrapStream: async ({ doStream }) => {
      ...
      let delayedTextStart: LanguageModelStreamPart | undefined
