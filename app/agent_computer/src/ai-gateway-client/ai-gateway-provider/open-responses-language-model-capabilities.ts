export type OpenResponsesLanguageModelCapabilities = {
...
export function getOpenResponsesLanguageModelCapabilities(modelId: string): OpenResponsesLanguageModelCapabilities {
