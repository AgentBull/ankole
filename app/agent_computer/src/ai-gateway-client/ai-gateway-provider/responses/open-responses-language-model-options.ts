...
export const openResponsesReasoningModelIds = [
  'o1',
  'o1-2024-12-17',
  'o3',
  'o3-2025-04-16',
...
export const openResponsesModelIds = [
  'gpt-4.1',
  'gpt-4.1-2025-04-14',
  'gpt-4.1-mini',
  ...
  'gpt-3.5-turbo-1106',
  'gpt-5-chat-latest',
  ...openResponsesReasoningModelIds
] as const

export type OpenResponsesModelId =
  | 'gpt-3.5-turbo-0125'
  | 'gpt-3.5-turbo-1106'
  | 'gpt-3.5-turbo'
  | 'gpt-4.1-2025-04-14'
...
export const openResponsesLanguageModelOptionsSchema = lazySchema(() =>
  zodSchema(
    z.object({
      /**
       * The ID of the provider conversation to continue.
       * You must create a conversation first via the provider API.
       ...
       *
       * The 'none' type for `reasoningEffort` is only available for GPT-5.1
       * models. Also, the 'xhigh' type for `reasoningEffort` is only available for
       * GPT-5.1-Codex-Max model. Setting `reasoningEffort` to 'none' or 'xhigh' with unsupported models will result in
       * an error.
       */
       ...
       * Enable this when the target OpenResponses model supports additional
      ...
      /**
       * A unique identifier representing your end-user, which can help the provider
...
export type OpenResponsesLanguageModelOptions = InferSchema<typeof openResponsesLanguageModelOptionsSchema>
