import type { ModelMessage, SystemModelMessage } from '@/ai-gateway-client/provider-utils'

/**
 * Instructions to include in the prompt. Can be used with `prompt` or `messages`.
 */
export type Instructions = string | SystemModelMessage | Array<SystemModelMessage>
