import type { LanguageModelCallOptions as ProviderLanguageModelCallOptions } from '@/ai-gateway-client/provider'
...
export type LanguageModelCallOptions = {
   ...
   */
  reasoning?: ProviderLanguageModelCallOptions['reasoning']
}
