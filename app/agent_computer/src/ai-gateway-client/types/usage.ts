import type {
  ImageModelUsage as ProviderImageModelUsage,
  JSONObject,
  LanguageModelUsage as ProviderLanguageModelUsage
 ...
 */
// TODO replace with EmbeddingModelUsage once available in @/ai-gateway-client/provider
...
export function asLanguageModelUsage(usage: ProviderLanguageModelUsage): LanguageModelUsage {
  return {
...
export function addLanguageModelUsage(usage1: LanguageModelUsage, usage2: LanguageModelUsage): LanguageModelUsage {
  return {
...
function addTokenCounts(tokenCount1: number | undefined, tokenCount2: number | undefined): number | undefined {
  return tokenCount1 == null && tokenCount2 == null ? undefined : (tokenCount1 ?? 0) + (tokenCount2 ?? 0)
}

/**
 * Usage information for an image model call.
 */
export type ImageModelUsage = ProviderImageModelUsage

export function addImageModelUsage(usage1: ImageModelUsage, usage2: ImageModelUsage): ImageModelUsage {
  return {
    inputTokens: addTokenCounts(usage1.inputTokens, usage2.inputTokens),
    outputTokens: addTokenCounts(usage1.outputTokens, usage2.outputTokens),
    totalTokens: addTokenCounts(usage1.totalTokens, usage2.totalTokens)
