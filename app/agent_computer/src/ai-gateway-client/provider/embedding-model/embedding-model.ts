import type { EmbeddingModelCallOptions } from './embedding-model-call-options'
import type { EmbeddingModelResult } from './embedding-model-result'
...
export type EmbeddingModel = {
   ...
   * by the user.
   */
  doEmbed(options: EmbeddingModelCallOptions): PromiseLike<EmbeddingModelResult>
}
