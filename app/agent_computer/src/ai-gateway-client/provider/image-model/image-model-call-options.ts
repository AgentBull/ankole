import type { SharedProviderOptions } from '../shared'
import type { ImageModelFile } from './image-model-file'

export type ImageModelCallOptions = {
  /**
